    ...
    def read_one_hearing_type(
        ...
        try:
            ...
            raise_http_exception(
                ...
                HTTPStatus.SERVICE_UNAVAILABLE,
                get_err_msg(
                    f"Error Retrieving HearingType By Id: {model_id}. Please Try Again!!!",
                    str(ex),
                ),
            )
    ...
    def update_one_hearing_type(
        ...
        try:
            ...
            raise_http_exception(
                ...
                HTTPStatus.SERVICE_UNAVAILABLE,
                get_err_msg(
                    f"Error Updating HearingType By Id: {model_id}. Please Try Again!!!",
                    str(ex),
                ),
            )
    ...
    def delete_one_hearing_type(
        ...
        try:
            ...
            raise_http_exception(
                ...
                HTTPStatus.SERVICE_UNAVAILABLE,
                get_err_msg(
                    f"Error Deleting HearingType By Id: {model_id}. Please Try Again!!!",
                    str(ex),
                ),
            )
