...
def find_all(
    ...
    return get_court_service().read_all_courts(
...
def find_one(
    ...
    validate_http_basic_credentials(request, http_basic_credentials)
    court_response: CourtResponse = get_court_service().read_one_court(
        court_id,
        request,
        is_include_extra,
        is_include_history,
...
def insert_one(
    ...
    validate_http_basic_credentials(request, http_basic_credentials)
    return get_court_service().create_one_court(request, court_request)
...
def delete_one(
    ...
    validate_http_basic_credentials(request, http_basic_credentials)
    return get_court_service().delete_one_court(court_id, request)
...
def update_one(
    ...
    validate_http_basic_credentials(request, http_basic_credentials)
    return get_court_service().update_one_court(court_id, request, court_request)
