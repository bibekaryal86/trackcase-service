...
def upgrade() -> None:
    ...
    sa.Column('status', sa.String(length=100), nullable=False),
    sa.Column('comments', sa.String(length=10000), nullable=True),
    sa.ForeignKeyConstraint(['court_id'], ['court.id'], onupdate='NO ACTION', ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('status', sa.String(length=100), nullable=False),
    sa.Column('comments', sa.String(length=10000), nullable=True),
    sa.ForeignKeyConstraint(['judge_id'], ['judge.id'], onupdate='NO ACTION', ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('a_number'),
    sa.UniqueConstraint('email'),
    sa.UniqueConstraint('name')
    )
    op.create_table('history_judge',
    sa.Column('user_name', sa.String(length=100), nullable=False),
    ...
    sa.Column('status', sa.String(length=100), nullable=False),
    sa.Column('comments', sa.String(length=10000), nullable=True),
    sa.ForeignKeyConstraint(['case_type_id'], ['case_type.id'], onupdate='NO ACTION', ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['client_id'], ['client.id'], onupdate='NO ACTION', ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('history_client',
    sa.Column('user_name', sa.String(length=100), nullable=False),
    sa.Column('client_id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=100), nullable=True),
    sa.Column('a_number', sa.String(length=100), nullable=True),
    ...
    op.create_table('hearing_calendar',
    ...
    sa.Column('status', sa.String(length=100), nullable=False),
    sa.Column('comments', sa.String(length=10000), nullable=True),
    sa.ForeignKeyConstraint(['court_case_id'], ['court_case.id'], onupdate='NO ACTION', ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['hearing_type_id'], ['hearing_type.id'], onupdate='NO ACTION', ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('history_court_case',
    sa.Column('user_name', sa.String(length=100), nullable=False),
    sa.Column('court_case_id', sa.Integer(), nullable=False),
    ...
    op.create_table('note_court_case',
    sa.Column('court_case_id', sa.Integer(), nullable=False),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('created', sa.DateTime(), nullable=False),
    sa.Column('modified', sa.DateTime(), nullable=False),
    ...
    op.create_table('history_hearing_calendar',
    sa.Column('user_name', sa.String(length=100), nullable=False),
    ...
    sa.Column('comments', sa.String(length=10000), nullable=True),
    sa.ForeignKeyConstraint(['court_case_id'], ['court_case.id'], onupdate='NO ACTION', ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['hearing_calendar_id'], ['hearing_calendar.id'], onupdate='NO ACTION', ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['hearing_type_id'], ['hearing_type.id'], onupdate='NO ACTION', ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('note_hearing_calendar',
    sa.Column('hearing_calendar_id', sa.Integer(), nullable=False),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('created', sa.DateTime(), nullable=False),
    sa.Column('modified', sa.DateTime(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['court_case_id'], ['court_case.id'], onupdate='NO ACTION', ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['hearing_calendar_id'], ['hearing_calendar.id'], onupdate='NO ACTION', ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['task_type_id'], ['task_type.id'], onupdate='NO ACTION', ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('comments', sa.String(length=10000), nullable=True),
    sa.ForeignKeyConstraint(['court_case_id'], ['court_case.id'], onupdate='NO ACTION', ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['form_type_id'], ['form_type.id'], onupdate='NO ACTION', ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['task_calendar_id'], ['task_calendar.id'], onupdate='NO ACTION', ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('history_task_calendar',
    sa.Column('user_name', sa.String(length=100), nullable=False),
    ...
    op.create_table('note_task_calendar',
    sa.Column('task_calendar_id', sa.Integer(), nullable=False),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('created', sa.DateTime(), nullable=False),
    sa.Column('modified', sa.DateTime(), nullable=False),
    ...
    op.create_table('case_collection',
    ...
    sa.Column('status', sa.String(length=100), nullable=False),
    sa.Column('comments', sa.String(length=10000), nullable=True),
    sa.ForeignKeyConstraint(['collection_method_id'], ['collection_method.id'], onupdate='NO ACTION', ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['court_case_id'], ['court_case.id'], onupdate='NO ACTION', ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['form_id'], ['form.id'], onupdate='NO ACTION', ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('history_form',
    sa.Column('user_name', sa.String(length=100), nullable=False),
    ...
    op.create_table('cash_collection',
    ...
    sa.Column('status', sa.String(length=100), nullable=False),
    sa.Column('comments', sa.String(length=10000), nullable=True),
    sa.ForeignKeyConstraint(['case_collection_id'], ['case_collection.id'], onupdate='NO ACTION', ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['collection_method_id'], ['collection_method.id'], onupdate='NO ACTION', ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('history_case_collection',
    sa.Column('user_name', sa.String(length=100), nullable=False),
    sa.Column('case_collection_id', sa.Integer(), nullable=False),
    ...
    op.create_table('note_case_collection',
    sa.Column('case_collection_id', sa.Integer(), nullable=False),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('created', sa.DateTime(), nullable=False),
    sa.Column('modified', sa.DateTime(), nullable=False),
    ...
    op.create_table('history_cash_collection',
    sa.Column('user_name', sa.String(length=100), nullable=False),
    ...
    sa.Column('comments', sa.String(length=10000), nullable=True),
    sa.ForeignKeyConstraint(['case_collection_id'], ['case_collection.id'], onupdate='NO ACTION', ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['cash_collection_id'], ['cash_collection.id'], onupdate='NO ACTION', ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['collection_method_id'], ['collection_method.id'], onupdate='NO ACTION', ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('note_cash_collection',
    sa.Column('cash_collection_id', sa.Integer(), nullable=False),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('created', sa.DateTime(), nullable=False),
    sa.Column('modified', sa.DateTime(), nullable=False),
