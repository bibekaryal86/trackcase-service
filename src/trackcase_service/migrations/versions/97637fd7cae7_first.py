...
def upgrade() -> None:
    ...
    op.create_index('task_calendar_hearing_calendar_id_1', 'task_calendar', ['hearing_calendar_id'], unique=False,
                    postgresql_where='(hearing_calendar_id IS NOT NULL)')
    op.create_index('task_calendar_form_id_1', 'task_calendar', ['form_id'], unique=False,
